...
ambiental_clustered[3:ncol(ambiental_clustered)] <- apply(
                ambiental_clustered[3:ncol(ambiental_clustered)],
                2,
                normalize
                                                         )
#Cheking the normalization
print(paste(
        "The mean of ambiental normalization is:",
        round(mean(ambiental_clustered$clay), 2)
           ),
     sep = " "
     )
print(paste(
        "The sd of ambiental normalization is:",
        sd(ambiental_clustered$clay)
            ),
    sep = " "
      )
